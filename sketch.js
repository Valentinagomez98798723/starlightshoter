...
function setup() {
  ...
  player = new Player(285, playerBase.body.position.y - 153, 80, 180);
  playerArcher = new PlayerArcher(339,playerBase.body.position.y - 197,30,70);


  computerBase = new ComputerBase(width - 300,random(450, height - 300),180,150);
  computer = new Computer(width - 300,computerBase.body.position.y - 153,100,160);
  computerArcher = new ComputerArcher(width - 340,computerBase.body.position.y - 180,120,80);
...
function draw() {
  ...
  textAlign("center");
  textSize(40);
  text("star light shoter", width / 2, 100);
